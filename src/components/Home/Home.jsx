...
export default function Home() {
    return (
        <div>
            ...
            <div className={styles.container}>
                <svg className={styles.ghost} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="227.433px" height="232.743px" viewBox="0 0 127.433 132.743" enableBackground="new 0 0 127.433 132.743" xmlSpace="preserve">
	...
	s12.625-8.375,12.625-8.375s2.25-3.875,7.25,0.375s7.625,9.75,14.375,8.125C114.739,126.01,115.412,125.902,116.223,125.064z" />
                    <circle fill="#013E51" cx="86.238" cy="57.885" r="7.667" />
                    <circle fill="#013E51" cx="40.072" cy="57.885" r="7.667" />
	...
	c-0.007,0.007-0.015,0.014-0.021,0.02C71.666,63.771,71.892,63.307,71.916,62.782z" />
                    <circle fill="#FCEFED" stroke="#FEEBE6" strokeMiterlimit={10} cx="18.614" cy="99.426" r="4.292" />
                    <circle fill="#FCEFED" stroke="#FEEBE6" strokeMiterlimit={10} cx="95.364" cy="28.676" r="4.291" />
                    <circle fill="#FCEFED" stroke="#FEEBE6" strokeMiterlimit={10} cx="24.739" cy="93.551" r="3.667" />
                    <circle fill="#FCEFED" stroke="#FEEBE6" strokeMiterlimit={10} cx="101.489" cy="33.051" r="3.666" />
                    <circle fill="#FCEFED" stroke="#FEEBE6" strokeMiterlimit={10} cx="18.738" cy="87.717" r="3.833" />
	...
	c7.636,0,15.336,1.684,22.887,5.004c26.766,11.771,29.011,39.047,29.027,39.251V121.405z" />
                ...
                <p className={styles.shadowFrame}><svg version="1.1" className={styles.shadow} id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="61px" y="20px" width="122.436px" height="39.744px" viewBox="0 0 122.436 39.744" enableBackground="new 0 0 122.436 39.744" xmlSpace="preserve">
